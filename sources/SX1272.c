...
void InitModule (void){
    ...
    WriteSXRegister(REG_MODEM_CONFIG1, 0x23); //BW=125k, CR=4/8, explicit header, CRC enable, LDRO enable
    //writeRegister(REG_MODEM_CONFIG1, 0b10001010); //BW=500k, CR=4/5, explicit header, CRC enable, LDRO disabled

    WriteSXRegister(REG_MODEM_CONFIG2, 0xC4); // SF=12, normal TX mode, AGC auto on, RX timeout MSB = 11
